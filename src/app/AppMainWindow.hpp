...
// ============================================================
// AppMainWindow â€” the application shell
// ============================================================
...
// Bridge for road_engine::versionString() (see include note above)
...
private:
    ...
    void setupMenuBar() {
        ...
        // View menu â€” workspace switching
    ...
    void setupToolBar() {
        ...
        // Workspace tabs (center-left) â€” checkable
    ...
    void setupCenterWidget() {
            ...
            connect(m_terrainStudioWidget->mapWidget(), &MapViewportWidget::mapClicked,
                    this, [this](double lat, double lon) {
                        m_statusLabel->setText(
                            QStringLiteral("Terrain â€” Clicked: %1, %2")
        ...
        // Page 2: Road Studio (LaneMaker's MainWindow â€” full road editor)
    ...
    void setupDockWidgets() {
        // Left dock â€” project tree / explorer
        ...
        // Right dock â€” inspector / properties
...
private slots:
    void onWorkspaceActivated(const Workspace& ws) {
        ...
        setWindowTitle(QStringLiteral("OpenGeoStudio â€” %1").arg(ws.name));
        updateStatusBar();
    ...
    // â”€â”€â”€ Project state save/load â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    void saveProjectState() {
        ...
        // â”€â”€ Terrain state â†’ moduleState â”€â”€
        QJsonObject moduleState;
        moduleState["terrain"] = m_ctx->terrain().toJson();

        // â”€â”€ Road network â†’ {project}/Roads/road.xodr â”€â”€
        if (m_roadStudioWidget && m_roadStudioWidget->laneMakerWindow()) {
    ...
    void loadProjectState() {
        ...
        // â”€â”€ Restore road network â€” defer loading until Road Studio is visible â”€â”€
        ...
        // Update project bounds in terrain store â€” but only if the terrain
